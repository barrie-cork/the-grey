...
class TestPrismaReportingService(TestCase):
    ...
    def test_generate_search_strategy_description(self):
        ...
        description = self.service.generate_search_strategy_description(str(self.session.id))
    ...
    def test_logging_in_report_generation(self):
        ...
        with self.assertLogs('apps.reporting.services.prisma_reporting_service', level='INFO') as cm:
