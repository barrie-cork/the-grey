...
calculate_review_period_from_data = prisma_reporting_service.calculate_review_period_from_data
...
generate_search_strategy_report = search_strategy_reporting_service.generate_search_strategy_report
generate_study_characteristics_table = study_analysis_service.generate_study_characteristics_table
calculate_search_performance_metrics = performance_analytics_service.calculate_search_performance_metrics
