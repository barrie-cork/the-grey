...
from apps.results_manager.services.quality_assessment_service import QualityAssessmentService
...
class TestQualityAssessmentService(TestCase):
    ...
    def setUp(self):
        ...
        # High quality result
        self.results.append(ProcessedResult.objects.create(
    ...
    def test_quality_threshold_filtering(self):
        ...
        high_quality = self.service.filter_by_quality_threshold(
            self.results,
            threshold
        )
    ...
    def test_logging_in_quality_assessment(self):
        ...
        with self.assertLogs('apps.results_manager.services.quality_assessment_service', level='INFO') as cm:
