...
class WorkflowTransitionTests(TestCase):
    ...
    def test_backward_transitions(self):
        ...
        session = SearchSession.objects.create(
            title='Backward Transition Test',
            owner=self.user,
            status='under_review'
        )
    ...
    def test_archive_from_any_state(self):
        ...
        archivable_states = [
            'draft', 'defining_search', 'ready_to_execute', 
    ...
    def test_unarchive_to_draft_only(self):
        ...
        other_states = [
            'defining_search', 'ready_to_execute', 'executing',
...
class ActivityLoggingTests(TestCase):
    ...
    def test_activity_types(self):
        ...
        activity_types = [
            'created', 'status_changed', 'search_defined',
            'search_executed', 'results_processed', 'review_started',
            'review_completed', 'exported', 'shared', 'note_added',
            'settings_changed'
        ]
