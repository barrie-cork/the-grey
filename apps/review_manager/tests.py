...
class FormsTests(TestCase):
    ...
    def test_session_create_form_required_title(self):
        ...
        form = SessionCreateForm(data={"description": "A test description"})
...
class ViewsTests(TestCase):
    ...
    def test_create_session_view(self):
        ...
        response = self.client.post(
            ...
            {"title": "New Test Session", "description": "New test description"},
        )
        self.assertEqual(response.status_code, 302)
        self.assertTrue(SearchSession.objects.filter(title="New Test Session").exists())
    ...
    def test_duplicate_session_view(self):
        ...
        duplicates = SearchSession.objects.filter(title__contains="(Copy)")
