    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decision', models.CharField(choices=[('pending', 'Pending Review'), ('include', 'Include'), ('exclude', 'Exclude'), ('maybe', 'Maybe/Uncertain')], default='pending', max_length=20)),
                ('exclusion_reason', models.CharField(blank=True, choices=[('not_relevant', 'Not Relevant'), ('not_grey_lit', 'Not Grey Literature'), ('duplicate', 'Duplicate'), ('no_access', 'Cannot Access'), ('other', 'Other')], max_length=20)),
                ('notes', models.TextField(blank=True, help_text='Optional reviewer notes')),
                ('reviewed_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('result', models.OneToOneField(on_delete=models.deletion.CASCADE, to='results_manager.processedresult')),
                ('reviewer', models.ForeignKey(null=True, on_delete=models.deletion.SET_NULL, to='accounts.user')),
            ],
            options={
        ...
        migrations.RunPython(
            migrate_review_data_forward,
            migrate_review_data_reverse
        ),
    ]