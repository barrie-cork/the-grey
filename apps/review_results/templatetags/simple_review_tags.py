...
def quick_decision_buttons(result) -> str:
    ...
    # Include button
    include_class = (
        "btn-success" if current_decision == "include" else "btn-outline-success"
    )
    buttons.append(
        format_html(
    ...
    # Exclude button
    exclude_class = (
        "btn-danger" if current_decision == "exclude" else "btn-outline-danger"
    )
    buttons.append(
        format_html(
    ...
    # Maybe button
    maybe_class = (
        "btn-warning" if current_decision == "maybe" else "btn-outline-warning"
    )
    buttons.append(
        format_html(
