...
from apps.review_results.services.simple_review_progress_service import SimpleReviewProgressService
...
class SimpleReviewProgressServiceTest(TestCase):
    ...
    def test_partial_progress(self):
        ...
        SimpleReviewDecision.objects.create(
            result=self.results[1], reviewer=self.user, decision='exclude', exclusion_reason='not_relevant'
        )
        SimpleReviewDecision.objects.create(
