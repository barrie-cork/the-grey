...
from ..models import SearchExecution, ExecutionMetrics
from ..utils import get_execution_statistics, categorize_failure
...
def execution_timeline_item(execution: SearchExecution) -> str:
    ...
    return format_html(
        ...
        time_display,
        f'<div class="mt-1"><small class="text-danger">{execution.error_message[:100]}...</small></div>' if execution.error_message else ''
    )
