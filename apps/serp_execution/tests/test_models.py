...
class SearchExecutionModelTests(TestCase):
    ...
    def test_status_choices(self):
        ...
        valid_statuses = ['pending', 'running', 'completed', 'failed', 'cancelled', 'rate_limited']
    ...
    def test_execution_indexes(self):
        ...
        execution = SearchExecution.objects.filter(
...
class RawSearchResultModelTests(TestCase):
    ...
    def test_raw_data_storage(self):
        ...
        self.assertEqual(result.raw_data['pagemap']['metatags'][0]['author'], 'Test Author')
    ...
    def test_cascade_delete(self):
        ...
        self.assertEqual(RawSearchResult.objects.filter(execution=self.execution).count(), 0)
...
class ExecutionMetricsModelTests(TransactionTestCase):
    ...
    def test_update_metrics_method(self):
        ...
        self.assertAlmostEqual(float(metrics.average_execution_time), 2.75, places=2)  # (2.5 + 3.0) / 2
    ...
    def test_quality_metrics(self):
        ...
        metrics = ExecutionMetrics.objects.create(
            session=self.session,
            academic_results_count=45,
            pdf_results_count=30
        )
